  ...
  return (
    <>
      <aside
        ...
        className="float-left flex flex-col justify-between z-40 w-64 h-[200vh] transition-transform -translate-x-full sm:translate-x-0 basis-[1] bg-[#1e2640]"
        aria-label="Sidebar"
      >
        <div className="px-3 py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            <li>
              <button
                type="button"
                className="flex items-center w-full p-2 mb-5 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              ...
              >
                ...
                <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                  Nishyan
                  <br />
                  <a href="#" className="underline text-[13px] text-slate-200">
                    Visit store
                  </a>
                </span>
                <svg
            ...
            <li>
              ...
              >
                ...
                >
                  ...
                  />
                  <path d="M18.6387 5.32573C18.919 5.67613 18.8622 6.18743 18.5118 6.46775L16.4284 8.13442C16.078 8.41474 15.5667 8.35793 15.2864 8.00753C15.0061 7.65713 15.0629 7.14583 15.4133 6.86551L17.4966 5.19884C17.847 4.91852 18.3583 4.97533 18.6387 5.32573Z" />
                  <path d="M15.5041 10.0208C15.5041 9.57208 15.8679 9.20831 16.3166 9.20831H18.8583C19.307 9.20831 19.6708 9.57208 19.6708 10.0208C19.6708 10.4695 19.307 10.8333 18.8583 10.8333H16.3166C15.8679 10.8333 15.5041 10.4695 15.5041 10.0208Z" />
                  <path d="M16.4284 12.2822C16.078 12.0019 15.5667 12.0587 15.2864 12.4091C15.0061 12.7595 15.0629 13.2708 15.4133 13.5511L17.4966 15.2178C17.847 15.4981 18.3583 15.4413 18.6387 15.0909C18.919 14.7405 18.8622 14.2292 18.5118 13.9489L16.4284 12.2822Z" />
                </svg>
            ...
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-700 group"
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
            ...
            <li>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                >
                  <path d="M4.87506 10.5889C5.63445 10.5889 6.25006 9.97329 6.25006 9.2139C6.25006 8.45451 5.63445 7.8389 4.87506 7.8389C4.11567 7.8389 3.50006 8.45451 3.50006 9.2139C3.50006 9.97329 4.11567 10.5889 4.87506 10.5889Z" />
                  <path d="M9 5.4639C9 6.22329 8.38439 6.8389 7.625 6.8389C6.86561 6.8389 6.25 6.22329 6.25 5.4639C6.25 4.70451 6.86561 4.0889 7.625 4.0889C8.38439 4.0889 9 4.70451 9 5.4639Z" />
                  <path d="M12.3751 6.8389C13.1345 6.8389 13.7501 6.22329 13.7501 5.4639C13.7501 4.70451 13.1345 4.0889 12.3751 4.0889C11.6157 4.0889 11.0001 4.70451 11.0001 5.4639C11.0001 6.22329 11.6157 6.8389 12.3751 6.8389Z" />
                  <path d="M16.5 9.2139C16.5 9.97329 15.8844 10.5889 15.125 10.5889C14.3656 10.5889 13.75 9.97329 13.75 9.2139C13.75 8.45451 14.3656 7.8389 15.125 7.8389C15.8844 7.8389 16.5 8.45451 16.5 9.2139Z" />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
        ...
        <div className="flex gap-5 items-center justify-between rounded-[4px] bg-[#353C53] px-5 py-2 w-[220px] mx-auto my-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          ...
          <div>
            <p className="text-slate-200 text-[13px]">Available credits</p>
            <p className="text-white text-center">222.10</p>
          </div>
        </div>
      </aside>
    </>
